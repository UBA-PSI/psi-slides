...
const STRINGS = {
  en: {
    ...
    'facts.chunks': 'Slides',
    'facts.pageWords': 'Words in the handout',
    'facts.noteWords': 'Words in the speaker notes',
    'facts.pictures': 'Pictures',
    'facts.drawings': 'Drawings',
    'facts.times': 'source.md was saved {saved}. The last build was {built}.',
    'facts.assets': 'Only source.md is watched. If you change a picture or a font beside it, press “Build now” – otherwise the views keep the old file.',
    'facts.wait': 'The numbers appear after the first build.',
    'facts.at': 'at {time}',
    'facts.atYesterday': 'yesterday at {time}',
    'facts.atDate': 'on {date} at {time}',
  ...
  de: {
    ...
    'facts.sections': 'Abschnitte',
    'facts.chunks': 'Folien',
    'facts.pageWords': 'Wörter im Handout',
    'facts.noteWords': 'Wörter in den Sprechernotizen',
    'facts.pictures': 'Bilder',
    'facts.drawings': 'Zeichnungen',
    'facts.times': 'source.md wurde {saved} gespeichert. Der letzte Build war {built}.',
    'facts.assets': 'Beobachtet wird nur source.md. Änderst du daneben ein Bild oder eine Schrift, drücke „Jetzt bauen“ – sonst bleibt die alte Datei in den Ansichten.',
    'facts.wait': 'Die Zahlen erscheinen nach dem ersten Build.',
    'facts.at': 'um {time}',
    'facts.atYesterday': 'gestern um {time}',
    'facts.atDate': 'am {date} um {time}',
