...
Ships into the live views whenever the lecture contains a diagram, gated by the `editor:` frontmatter key (`both` / `speaker` / `none`). 133 KB of compiler plus UI, on top of the 276 KB of fonts. A lecture with no diagram pays nothing.
