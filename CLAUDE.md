...
- `test/README.md` – **the two test suites and which one a thing belongs in**: what each of the eleven gates guards, the four browser-spec families, and the nine specs that build a deck of their own rather than hunting shapes in a real one.
